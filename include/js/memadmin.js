...
$(function() {
	...
	$(".econ").click(function() {
		...
		$("#mainframe",parent.document.body).attr("src","views/memmanager.php?type=con&num="+num+"&action=memget");
		$("#showlist").hide();
		$("#dropbut a").css("background-position","0px 0px");
	});
	$(".econp").click(function() {
		...
		type='conp';
		num=$(this).find(".hide_num").val();
		$("#mainframe",parent.document.body).attr("src","views/memmanager.php?type=conp&num="+num+"&action=filtertrav");
		$("#showlist").hide();
		$("#dropbut a").css("background-position","0px 0px");
	});
