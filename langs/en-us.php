...
//item_filtertrav.php
$langs['itemft_tit']="Memcache服务器不支持模糊查询，所以这里先获取所有的Key然后文件缓存6小时。帮助查找Key";
...
$langs['itemft_filter']="Search Pattern";
...
$langs['createdtime']="CreateTime";
$langs['lastupdatetime']="LastAccessTime";
$langs['itemft_tit_search']="Search";
